...
#pragma pack(pop)
    ...
    {
        // D2GI CHANGE BEGIN
        // We don't need CLSID_WICImagingFactory2 anyway
    ...
    {
        // D2GI CHANGE BEGIN
        // Use a static local variable and an immediately executed lambda instead of InitOnceExecuteOnce
        // + /Zc:threadSafeInit- for WinXP compatibility
        ...
        static IWICImagingFactory* factory = [] {
            IWICImagingFactory* factory = nullptr;
            InitializeWICFactory(nullptr, nullptr, reinterpret_cast<LPVOID*>(&factory));
            return factory;
           }();
        // D2GI CHANGE END
